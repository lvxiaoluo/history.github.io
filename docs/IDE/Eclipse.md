...
![](../../media/pictures/tools/eclipse/Eclipse中JDK的JVM参数设置.png)

#### 设置Tomcat参数

![](../../media/pictures/tools/eclipse/Eclipse中Tomcat的JVM参数设置.png)
...
![](../../media/pictures/tools/eclipse/Eclipse保存自动优化设置.png)
...
![](../../media/pictures/tools/eclipse/Eclipse自动添加注释.png)
...
![](../../media/pictures/tools/eclipse/Eclipse不格式化注释.png)
...
![](../../media/pictures/tools/eclipse/Eclipse-Insert-spaces-for-tabs.png)

![](../../media/pictures/tools/eclipse/Eclipse-Tab-policy.png)
