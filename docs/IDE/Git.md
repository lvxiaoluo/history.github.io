...
- [git-pull.bat](../../media/files/git-pull.bat)
- [git-pull.sh](../../media/files/git-pull.sh)
...
```
> compression 是压缩的意思，从 clone
> 的终端输出就知道，服务器会压缩目标文件，然后传输到客户端，客户端再解压。 取值为
> \[-1, 9\]，-1 以 zlib 为默认压缩库，0 表示不进行压缩，1..9
> 是压缩速度与最终获得文件大小的不同程度的权衡，
...
* [Windows设置GitHub的Hosts脚本](../../media/files/设置GitHub的Hosts.bat)
