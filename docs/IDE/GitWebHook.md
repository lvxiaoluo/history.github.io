...
![](../../media/pictures/tools/git/宝塔WebHook设置.png)
...
![](../../media/pictures/tools/git/宝塔WebHook获取url.png)
...
![](../../media/pictures/tools/git/GiteaWebHook设置.png)

### 添加接收通知url

![](../../media/pictures/tools/git/GiteaWebHook添加.png)

### 测试推送

![](../../media/pictures/tools/git/GiteaWebHook测试.png)
