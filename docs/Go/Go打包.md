...
> 只需下载[go_7z_pack.bat](../../media/files/go/go_7z_pack.bat)文件并保存到项目根目录中，且修改脚本中的`files`变量保存执行脚本即可
...
<!--* [go_7z_pack_arbitrary.bat](../../media/files/go/go_7z_pack_arbitrary.bat)-->